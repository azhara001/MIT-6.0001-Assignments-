# -*- coding: utf-8 -*-
"""
Created on Fri Jul  9 16:54:52 2021

@author: Abdullah Azhar
"""


#calculate when will you be able to save money for the downpayment in months after INCREMENT every 6 months 
...
monthly_savings = portion_saved*monthly_salary #savings for the first month 
...
semi_annual_raise = float(input('Kindly input the semi-annual raise (as a percentage)'))
